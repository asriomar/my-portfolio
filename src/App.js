  ...
  return (
    <div className=" bg-gray-100 font-mono">
      ...
      <section className="max-w-screen-md mx-auto my-8 p-8 bg-white shadow-md ">
        ...
        <p className="text-gray-700 m-2 tracking-wide md:text-justify text-xl">
          👋 Hi there! I'm{" "}
        ...
        <p className="text-gray-700 m-4 tracking-wide md:text-justify text-xl">
...
<svg role="img" width="64" height="64" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"> <title>Chakra UI</title><path d="M12 0C5.352 0 0 5.352 0 12s5.352 12 12 12 12-5.352 12-12S18.648 0 12 0zm2.8 4.333c.13-.004.248.136.171.278l-3.044 5.58a.187.187 0 00.164.276h5.26c.17 0 .252.207.128.323l-9.22 8.605c-.165.154-.41-.063-.278-.246l4.364-6.021a.187.187 0 00-.151-.296H6.627a.187.187 0 01-.131-.32l8.18-8.123a.182.182 0 01.125-.056z"/></svg>
      ...
      <section className="max-w-screen-md mx-auto my-8 p-8 bg-white shadow-md text-2xl">
        ...
        <div className='grid md:grid-cols-3 gap-2 justify-between'>
          <div className='text-base text-mono w-[64] bg-lime-200 justify-self-center p-4 shadow-lg my-2 text-center  rounded-lg'><a href="https://to-do-sort.vercel.app/"> Job To Do and Sort App</a></div>
          <div className='text-base text-mono w-[64] bg-gray-200 justify-self-center p-4 shadow-lg my-2 text-center  rounded-lg'><a href="https://react-quiz-app-psi-six.vercel.app/"> Quizz App</a></div>
          <div className='text-base text-mono w-[64] bg-lime-200 justify-self-center p-4 shadow-lg my-2 text-center  rounded-lg'><a href="https://student-registration-pied.vercel.app//"> Student Registration</a></div>
          <div className='text-base text-mono w-[64] bg-gray-200 justify-self-center p-4 shadow-lg my-2 text-center  rounded-lg'><a href="https://to-do-sort.vercel.app/"> Shopping Cart</a></div>
          <div className='text-base text-mono w-[64] bg-lime-200 justify-self-center p-4 shadow-lg my-2 text-center  rounded-lg'><a href="https://to-do-sort.vercel.app/"> Badminton Score</a></div>
          <div className='text-base text-mono w-[64] bg-gray-200 justify-self-center p-4 shadow-lg my-2 text-center  rounded-lg'><a href="https://to-do-sort.vercel.app/"> Stop Watch</a></div>
        </div>
